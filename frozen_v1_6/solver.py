...
def solve_melody(
    ...
    *,
    ...
    # P2.6-C3: K=50 (was 3) — acknowledge SATB multi-solution nature
    # K-sweep data (P2.6-C2): K=3 → 2.39 distinct, K=10 → 4.16, K=50 → 6.41, K=200 → 9.46
    # K-bound fully open, no plateau at K=200
    # runtime: K=3 281ms → K=50 4645ms (16.5x), K=200 18274ms (65x)
    # K=50: 6.41 distinct/beat, 2min total for 19 cases — practical for educational use
    beam_k: int = 50,
    top_n: int = 50,
